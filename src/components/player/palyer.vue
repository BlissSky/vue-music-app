<template>
  <div class="player" v-show="playlist.length>0">
      ...
      <div class="bottom">
        ...
        <div class="progress-wrapper">
          ...
          <div class="progress-bar-wrapper">
            <process-bar :persent="persent" @percentChange="onProcessBarChange"></process-bar>
          </div>
        ...
        <div class="operators">
          ...
          <div class="icon i-center" :class="disableCls">
            <i :class="togglePause" @click="togglePlaying" ref="togglePause"></i>
          </div>
    ...
    <div class="mini-player" v-show="!fullScreen" @click="open">
      ...
      <div class="control">
        <progress-circle :radius="radius" :percent="persent">
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      onProcessBarChange(newPersent){
        const currentTime = this.currentSong.duration * newPersent
      ...
      middleTouchEnd(){
        ...
        this.$refs.middleL.style.opacity = oppacity
